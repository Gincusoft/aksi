 ...
 * @author tumbas
 */
class Journals extends Tumbas_Controller {

  public function __construct() {
    parent::__construct();
    $this->load->model(array('journals_model'));
  }
      ...
      if ($this->input->post() == FALSE) {
        ...
        if ($this->form_validation->run() == TRUE) {
          ...
          if ($this->db->trans_status() == TRUE) {
            $response = array(
                'status' => 'success',
                'message' => 'Berhasil menyimpan jurnal. Tambah lagi?',
//                'journals_id' => encode($journals)
      ...
      if ($this->input->post() == FALSE) {
        ...
        if ($this->form_validation->run() == TRUE) {
          ...
          if ($this->db->trans_status() == TRUE) {
            $response = array(
                'status' => 'success',
                'message' => 'Berhasil mengedit jurnal.',
            );
          } else {
            $response = array(
                'status' => 'error',
                'message' => 'Gagal mengedit jurnal.'
            );
          }
        } else {
          $response = array(
  ...
  public function delete() {
    $this->form_validation->set_rules('journals_id', 'Journals ID', 'trim|required');
